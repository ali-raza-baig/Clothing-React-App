                ...
                <div className="container mx-auto px-4 py-8">
                    <div className="flex flex-wrap -mx-4">
                        ...
                        <div className="w-full md:w-1/2 px-4 mb-8">
                            <img src="/images/IMG-20240723-WA0022.jpg" alt="Product" className="w-full h-auto rounded-lg shadow-md mb-4" id="mainImage" />
                            <div className="flex gap-4 py-4 justify-center overflow-x-auto">
                                <img src="/images/IMG-20240723-WA0022.jpg" alt="Thumbnail 1" className="size-16 sm:size-20 object-cover rounded-md cursor-pointer opacity-60 hover:opacity-100 transition duration-300" />
                                <img src="/images/IMG-20240723-WA0023.jpg" alt="Thumbnail 2" className="size-16 sm:size-20 object-cover rounded-md cursor-pointer opacity-60 hover:opacity-100 transition duration-300" />
                                <img src="/images/IMG-20240723-WA0024.jpg" alt="Thumbnail 3" className="size-16 sm:size-20 object-cover rounded-md cursor-pointer opacity-60 hover:opacity-100 transition duration-300" />
                                <img src="/images/IMG-20240723-WA0026.jpg" alt="Thumbnail 4" className="size-16 sm:size-20 object-cover rounded-md cursor-pointer opacity-60 hover:opacity-100 transition duration-300" />
                            </div>
                        </div>
                        {/* Product Details */}
